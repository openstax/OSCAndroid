...
class WebviewLogicTest
{
    ...
    fun testGetPdfUrl()
    {
        ...
        //val url:String = webLogic.getPDFUrl("American Government 2e")
        //val url:String = webLogic.getPDFUrl("Principles of Accounting, Volume 1: Financial Accounting")
        //val url:String = webLogic.getPDFUrl("Principles of Accounting, Volume 2: Managerial Accounting")
        //val url:String = webLogic.getPDFUrl("Principles of Management")
        //val url:String = webLogic.getPDFUrl("College Physics")
        //val url:String = webLogic.getPDFUrl("Precalculus")
        //val url:String = webLogic.getPDFUrl("Chemistry: Atoms First 2e")
        val url:String? = webLogic.getPDFUrl("Chemistry 2e")
