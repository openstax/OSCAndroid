...
public class FileBrowserActivity extends SherlockListActivity
{
     ...
     */
    private File currentDirectory = new File(Environment.getExternalStorageDirectory(), "OpenStaxCollege/");
    /**
    ...
    {
        currentDirectory = new File(Environment.getExternalStorageDirectory(), "OpenStaxCollege/");
    ...
    private void handleFile(final File dirOrFile)
    {
        ...
        if (dirOrFile.isDirectory() && !dirOrFile.getPath().endsWith("OpenStaxCollege/"))
        {
    ...
    private void openFile(File file)
    {
        ...
        File newFile = new File(Environment.getExternalStorageDirectory() + "/OpenStaxCollege/" + file.getName());
